...
func DefaultSettings() []Settings {
	...
	return []Settings{
		...
		{SortOrder: 220, Key: SettingOutputFilenameFormat, Value: "{branch_id}_{date}_{gate_id}", Name: "Filename Format", Icon: "FileCode", Group: "PDF", DataType: "string", Content: htmlContent("Template for output filenames.<br>Available variables: {branch_id}, {date}, {gate_id}")},
